...
<html lang="es">
  <head>
    ...
    <meta name="description" content="Perfil del técnico donde puede ver y modificar algunos de sus datos">
  </head>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="nav nav-tabs ms-auto">
              <li class="nav-item">
                <a class="nav-link active" href="tecnico-perfil.php"><img src="img/cliente.png" width="20rem" alt=""> Perfil</a>
              </li>
              <li class="nav-item">
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3 mt-3">
                        <div class="col-md-6">
                          ...
                          <input type="nombre" class="form-control" id="nombre-rep" placeholder="Andres Torres">
                        </div>
                        <div class="col-md-6">
