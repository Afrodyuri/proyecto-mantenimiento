...
<html lang="es">
  <head>
    ...
    <meta name="description" content="Perfil del usuario donde puede ver y modificar algunos de sus datos">
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3 mt-3">
                        <div class="col-md-6">
                          ...
                          <input type="nombre" class="form-control" id="nombre-rep" placeholder="Esmeralda Andrade">
                        </div>
                        <div class="col-md-6">
